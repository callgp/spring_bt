...
package com.gp.springcore.stereotype.collection;
...
public class Test {
	...
	public static void main(String[] args) {
		ApplicationContext ctx = new ClassPathXmlApplicationContext("com/gp/springcore/stereotype/collection/config.xml");
