...
package com.gp.springcore.advanced.standalone.collections;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext("com/gp/springcore/advanced/standalone/collections/config.xml");
		ProductsList pl = (ProductsList) ctx.getBean("productslist");
		System.out.println("ProductList details: " + pl);
